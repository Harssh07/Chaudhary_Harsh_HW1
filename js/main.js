(() => {
    ...
    <metadata xmlns:d="https://loading.io/stock/" style="animation-play-state:paused" ><d:name style="animation-play-state:paused" >spiral</d:name>
    
    
    <d:tags style="animation-play-state:paused" >camera,shutter,exposure,aperture,spinner,rotate,spiral</d:tags>
    
    
    <d:license style="animation-play-state:paused" >by</d:license>
    
    
    <d:slug style="animation-play-state:paused" >edfsjn</d:slug></metadata></g><!-- generated by https://loading.io/ --></svg>
    `;
